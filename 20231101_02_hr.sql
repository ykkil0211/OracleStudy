...
-- ㅇ EMPLOYEES 테이블의 직원들 SALARTY를 10% 인상함
-- 단, 부서명이 "IT"인 직원들만 한정함
-- (또한, 쿼리문에 대한변경 결과 확인 후 ROLLBACK을 수행함)
...
WHERE A.DEPARTMENT_ID = B.DEPARTMENT_ID AND B.DEPARTMENT_NAME = 'IT';
/*
103	Alexander	Hunold	     AHUNOLD	590.423.4567	2006-01-03	IT_PROG	9000		102	60	60	IT	103	1400
104	Bruce	    Ernst	     BERNST	    590.423.4568	2007-05-21	IT_PROG	6000		103	60	60	IT	103	1400
105	David	    Austin	     DAUSTIN	590.423.4569	2005-06-25	IT_PROG	4800		103	60	60	IT	103	1400
106	Valli	    Pataballa	 VPATABAL	590.423.4560	2006-02-05	IT_PROG	4800		103	60	60	IT	103	1400
107	Diana	    Lorentz	     DLORENTZ	590.423.5567	2007-02-07	IT_PROG	4200		103	60	60	IT	103	1400
*/

UPDATE EMPLOYEES
SET SALARY = SALARY + (SALARY * 1.0)
...
-- ㅇ EMPLOYEES 테이블에서 JOB TITLE이 'SALES MANAGER'인 사원들의 SALLARY를 
-- 해당 직무(직종)의 최고급여(MAX_SALARY)로 수정함
-- 단, 입사일이 2006년 이전(해당 년도 제외) 입사자에 한해 적용할 수 있도록 처리 
-- (또한, 변경에 대한 결과 확인 후 ROLLBACK 수행함)
...
WHERE JOB_ID = (SELECT JOB_ID 
                FROM JOBS
                WHERE JOB_TITLE = 'Sales Manager' AND TO_CHAR(HIRE_DATE,'YYYY') < '2006');
-- 3개 행 이(가) 업데이트되었습니다.
/*
100	Steven	King	SKING	515.123.4567	2003-06-17	AD_PRES	24000			90
101	Neena	Kochhar	NKOCHHAR	515.123.4568	2005-09-21	AD_VP	17000		100	90
...
-- EMPLOYEES 테이블에서 SALARY를 각 부서의 이름별로 다른 인상률을 적용하여 수정할 수 있도록 함
-- FINANCE -> 10% 인상
-- EXECUTIVE -> 15% 인상
-- ACCOUNTING -> 20% 인상
...
UPDATE EMPLOYEES
SET SALARY = (SELECT CASE WHEN DEPARTMENT_NAME = 'Finance' THEN SALARY + (SALARY * 1.0)
                          WHEN DEPARTMENT_NAME = 'Executive' THEN SALARY + (SALARY * 1.15)
                          WHEN DEPARTMENT_NAME = 'Accounting' THEN SALARY + (SALARY * 1.2)
                    ELSE 0
                END 인상가격 
              FROM DEPARTMENTS
...
/*
100	Steven	King	SKING	515.123.4567	2003-06-17	AD_PRES	60000			90
101	Neena	Kochhar	NKOCHHAR	515.123.4568	2005-09-21	AD_VP	42500		100	90
102	Lex	De Haan	LDEHAAN	515.123.4569	2001-01-13	AD_VP	42500		100	90
103	Alexander	Hunold	AHUNOLD	590.423.4567	2006-01-03	IT_PROG	9000		102	60
104	Bruce	Ernst	BERNST	590.423.4568	2007-05-21	IT_PROG	6000		103	60
105	David	Austin	DAUSTIN	590.423.4569	2005-06-25	IT_PROG	4800		103	60
106	Valli	Pataballa	VPATABAL	590.423.4560	2006-02-05	IT_PROG	4800		103	60
107	Diana	Lorentz	DLORENTZ	590.423.5567	2007-02-07	IT_PROG	4200		103	60
108	Nancy	Greenberg	NGREENBE	515.124.4569	2002-08-17	FI_MGR	24016		101	100
109	Daniel	Faviet	DFAVIET	515.124.4169	2002-08-16	FI_ACCOUNT	18000		108	100
110	John	Chen	JCHEN	515.124.4269	2005-09-28	FI_ACCOUNT	16400		108	100
111	Ismael	Sciarra	ISCIARRA	515.124.4369	2005-09-30	FI_ACCOUNT	15400		108	100
112	Jose Manuel	Urman	JMURMAN	515.124.4469	2006-03-07	FI_ACCOUNT	15600		108	100
113	Luis	Popp	LPOPP	515.124.4567	2007-12-07	FI_ACCOUNT	13800		108	100
114	Den	Raphaely	DRAPHEAL	515.127.4561	2002-12-07	PU_MAN	11000		100	30
115	Alexander	Khoo	AKHOO	515.127.4562	2003-05-18	PU_CLERK	3100		114	30
116	Shelli	Baida	SBAIDA	515.127.4563	2005-12-24	PU_CLERK	2900		114	30
117	Sigal	Tobias	STOBIAS	515.127.4564	2005-07-24	PU_CLERK	2800		114	30
...
203	Susan	Mavris	SMAVRIS	515.123.7777	2002-06-07	HR_REP	6500		101	40
204	Hermann	Baer	HBAER	515.123.8888	2002-06-07	PR_REP	10000		101	70
205	Shelley	Higgins	SHIGGINS	515.123.8080	2002-06-07	AC_MGR	36024		101	110
206	William	Gietz	WGIETZ	515.123.8181	2002-06-07	AC_ACCOUNT	24900		205	110
*/
...
-- ㅇ EMPLOYEES 테이블에서 직원들의 데이터를 삭제함
-- 단, 부서명이 'IT'인 경우로 한정함
